...
const navItems = [
  {
    ...
    preview: {
      ...
      content: "Discover our latest collection of men's footwear, from casual sneakers to formal dress shoes."
    },
    sections: [
  ...
  },
  {
    ...
    preview: {
      image: "/placeholder.svg",
      content: "Explore trendy and comfortable women's shoes for every occasion, from heels to flats."
    },
    sections: [
  ...
  },
  {
    ...
    preview: {
      image: "/placeholder.svg",
      content: "Check out our versatile unisex footwear options, perfect for any style and preference."
    },
    sections: [
        ...
        <ul className="flex space-x-8 justify-center justify-self-center flex-1">
            {navItems.map((item) => (
              ...
              >
                ...
                <AnimatePresence>
                  {activeItem === item.title && clickedItem !== item.title && (
                    <motion.div
                    ...
                    >
                      <div className="p-4 flex">
                        <div className="w-1/2 pr-4 border-r">
                          <h3 className="font-semibold mb-2 dark:text-black">Main Categories</h3>
                        ...
                        <div className="w-1/2 pl-4">
                          <h3 className="font-semibold dark:text-black mb-2">{item.title} Categories</h3>
                          <ul className="space-y-2">
